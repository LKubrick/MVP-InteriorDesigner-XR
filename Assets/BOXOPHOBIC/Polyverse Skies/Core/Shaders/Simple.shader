	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float temp_output_7_0_g6 = 0.0;
				float lerpResult678 = lerp( saturate( pow( ( ( abs( VertexPos1217.y ) - temp_output_7_0_g6 ) / ( _FogHeight - temp_output_7_0_g6 ) ) , ( 1.0 - _FogSmoothness ) ) ) , 0.0 , _FogFill);
...
Node;AmplifyShaderEditor.Vector3Node;938;-896,-1024;Half;False;Global;GlobalSunDirection;GlobalSunDirection;38;0;Create;True;0;0;0;False;0;False;0,0,0;-0.6106748,0.787823,-0.08007157;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;1253;-320,896;Inherit;False;Remap To 0-1 1;-1;;6;d6eb10c035ec242479a0519a8ea4fd0f;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1254;0,-2560;Inherit;False;Remap To 0-1 1;-1;;7;d6eb10c035ec242479a0519a8ea4fd0f;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=49950B396E3BA56532EA0B4406FA8A1FC71FCC5D